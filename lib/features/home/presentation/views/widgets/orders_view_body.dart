...
class _OrdersViewBodyState extends State<OrdersViewBody> {
  ...
  Future<Either<Failure, List<UserOrderEntity>>> _loadOrders() {
    return getIt<OrderRepo>().getUserOrders(userId: getUser().uId);
  }
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              buildAppBar(context, title: 'طلباتي', showBackButton: false),
